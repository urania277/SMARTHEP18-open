...
\usepackage[lists=tight, title=tight, sections=tight, margins=normal, wordspacing=normal, paragraphs=tight, tracking=tight, charwidths=tight]{savetrees} %wordspacing=normal, 
...
\titleformat{\section}{\Large\fontseries{b}\color{blue}}{B2.\thesection.}{1em}{}
\titleformat{\subsection}{\large\fontseries{b}\color{blue}}{B2.\thesubsection}{1em}{}
\titleformat{\subsubsection}{\fontseries{b}\color{blue}}{B2.\thesubsubsection}{1em}{}
...
\rhead{}
\lfoot{}
\cfoot{\textbf{Part B2\ -\ Page \thepage}}%\ of 34}} %\pageref{LastPage}}}
\rfoot{}
...
%Partners
\includepdf[pages={1,2}]{LOC/Ximantis} %ok
\includepdf[pages={1,2}]{LOC/Point8}%ok
\includepdf[pages={1}]{LOC/Lightbox} %ok
\includepdf[pages={1}]{LOC/INFN} %ok
\includepdf[pages={1}]{LOC/Santiago} %ok
\includepdf[pages={1,2}]{LOC/Oregon}
\includepdf[pages={1}]{LOC/OSU} %ok
\includepdf[pages={1}]{LOC/Lieges} %ok
\includepdf[pages={1,2}]{LOC/VU} %ok
\includepdf[pages={1}]{LOC/Radboud} %ok
\includepdf[pages={1,2}]{LOC/UniBo}%ok
...
\includepdf[pages={1}]{LOC/HSF}%ok

\section*{SEALS OF EXCELLENCE}

\includepdf[pages={1}]{LOC/Ximantis_Seal_Of_Excellence}%ok
