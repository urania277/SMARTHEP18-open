...
%automate spacesaving - 2017 - ants in the eyes of the evaluators
...
%\usepackage[lists=tight, title=tight, sections=tight, margins=normal, paragraphs=tight, tracking=tight, wordspacing=normal]{savetrees} %wordspacing=normal, 
