...
\input{NodeDescriptions/DreamQuark}
\input{NodeDescriptions/NIKHEF}
\input{NodeDescriptions/Heidelberg}
\input{NodeDescriptions/IBM}

%Partners
\input{NodeDescriptions/Fleetmatics}%slightly too long
\input{NodeDescriptions/Ximantis}%too long
\input{NodeDescriptions/Lightbox}%too long
\input{NodeDescriptions/CATHi}
\input{NodeDescriptions/WildTreeTech}
\input{NodeDescriptions/HIMT}%messy
\input{NodeDescriptions/Santiago}%~ok
\input{NodeDescriptions/Pisa}%~ok
\input{NodeDescriptions/OSU}
\input{NodeDescriptions/Oregon}
\input{NodeDescriptions/Cincinnati}
\input{NodeDescriptions/VU}
\input{NodeDescriptions/Radboud}%very minimal
