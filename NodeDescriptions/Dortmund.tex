...
\pbox{19cm}{\Tstrut TU Dortmund University is hosting more than 34,000 students. 
...
Recently, the group intensified its collaboration with the local computer science department by joining the Collaborative Research Center SFB 876 "ÄúProviding Information by Resource-Constrained Data Analysis". 
...
Project leader in the computer science special research area "Providing Information by Resource-Constrained Data Analysis"Äù (SFB876). 
...
The group experimental physics 5 participates in the special research area "ÄúProviding Information by Resource-Constrained Data Analysis"Äù (SFB876), which ideally complements the proposed ITN. 
...
\begin{itemize}%[topsep=0pt,itemsep=-2pt,leftmargin=*]
 ...
 \item The LHCb and CMS Collaborations, "Observation of the rare $B^0_s \rightarrow \mu^+ \mu^-$ decay", Nature 522 (2015) 68‚Äì72
