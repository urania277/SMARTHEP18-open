...
<<<<<<< Updated upstream
\item[K. El Mernissi, with P. Feillet as industrial advisor] A study of explanation generation in a rule-based system. Artificial Intelligence [cs.AI]. Universite Pierre et Marie Curie - Paris VI, 2017. 
...
=======
\item[P. Feillet] Patents related to decision-making and rule induction \url{https://patents.google.com/?inventor=pierre+feillet&assignee=International+Business+Machines+Corporation}
\item[P. Feillet et al.] Introducing Causality in Business Rule-Based Decisions \href{https://link.springer.com/chapter/10.1007/978-3-319-60042-0_47}{Part of the Lecture Notes in Computer Science book series (LNCS, volume 10350), Springer}

%\item[K. El Mernissi, with P. Feillet as industrial advisor] A study of explanation generation in a rule-based system. Artificial Intelligence [cs.AI]. Université Pierre et Marie Curie - Paris VI, 2017. 
%\item[P. Feillet] Automate big decisions in a big data world, \href{IBM Big Data blog}{https://www.ibm.com/blogs/cloud-computing/2017/07/07/ai-enterprises-big-decisions/}
>>>>>>> Stashed changes
...
%\item[Hugues Juille and Jordan B. Pollack.] €œCoevolutionary Learning and the Design of Complex Systems. 
