...
\noindent{\color{blue}{State of the art}.}
...
\noindent{\color{blue}{Originality, relevance and timeliness of the program}.}
...
\noindent {\color{blue}{1. Researchers from \acronym learn to process large datasetsusing novel analysis techniques}.}
