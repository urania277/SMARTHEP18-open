...
\textbf{Research Objective:} & \textbf{Outcomes:} \\
\hline
implement outlier detection techniques in physics and industry & potential for not-yet-theorized discoveries at the LHC, improved fraud detection algorithms and IoT-ready industrial production chains(ADD DELIVERABLES) ;\\
\hline
...
\acronym defines four research WPs, corresponding to each of the research topics and objectives in the previous section, and three WPs for the management of the consortium, for training, and for outreach and dissemination. These are summarized in the Table below and a description of the overall tasks can be found in Sec.~\ref{sec:WPdescription}. Fig 1. gives a schematic view of the four research WPs and the main actors within the consortium. 

%\vskip10pt
\begin{center}
\scriptsize
%\resizebox {\textwidth }{!}{%
%\begin{tabular}{p{7mm}p{30mm}p{10mm}p{5mm}p{5mm}p{35mm}p{17mm}p{17mm}}
...
%Gligorov
\cellcolor{orange} \textbf{\color{black}WP3\color{black}}   & ML, AI and data analysis &  N, Gligorov & 1 & 48 & Research& \cnrs & 1-14 \tabularnewline \hline \midrule%: Software and algorithms enabling RTA
%\multicolumn{8}{p{0.95\textwidth}}{
%ESRs: 1-14
%Different ML algorithms are investigated by ESRs 1-3, 6, 9 for object reconstruction and feature identification, and for benchmarking and optimisation purposes by ESRs 4, 5, 7, 8, 10-12. 
%Custom algorithms for real-time object reconstruction will be deployed by ESRs 3-5, 7, 14, 15.
...
%%%%
%Lacassagne
\cellcolor{yellow} \textbf{\color{black}WP4\color{black}}    & Hybrid architectures & N, Lacassagne & 1 & 48 & Research & \sorbonneentity  & 2,3,6,7,11-13,15 \tabularnewline \hline \midrule% : Novel hardware for detectors and computing 
%\multicolumn{8}{p{0.95\textwidth}}{
...
%%%%%%
%Albrecht, Sopasakis 
\cellcolor{green} \textbf{\color{black}WP5\color{black}}   & \makecell[vl]{Real-time decision making} & N, Albrecht/Sopasakis & 1 & 48 & Research & \makecell[vl]{\dortmundentity} & All \tabularnewline\hline \midrule%: Physics measurements and searches
%\multicolumn{8}{p{0.95\textwidth}}{
...
%%%%
%%%%
%De Sainte Marie, Pierini
\cellcolor{cyan} \textbf{\color{black}WP6\color{black}}   & Monitoring \& discoveries & N, de Sainte Marie/Pierini & 1 & 48 & Research& \ibmentity & 1,4,6,8-10,13-15 \tabularnewline\hline \midrule%: Exploitation of RTA 
%\multicolumn{8}{p{0.95\textwidth}}{
%ESRs: \ESRa, \ESRd, \ESRf, \ESRj, \ESRk, \ESRl, \ESRx, \ESRn, \ESRm
%%\textbf{Motivation:} 
