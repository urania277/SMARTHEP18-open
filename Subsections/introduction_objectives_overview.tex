...
\acronym defines WPs for the management of the consortium (\textbf{{\colorbox{red!70!black}{\color{white}WP1\color{black}}}}), for training (\textbf{\colorbox{red}{WP2}}), and for outreach and dissemination, and four research WPs, corresponding to each of the research topics in the previous section. 
