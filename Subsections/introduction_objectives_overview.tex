...
These training goals define the four main research topics for \acronym, each corresponding to a research Work Package (WP) detailed in Sec.~\ref{sec:metho} and with objectives shown in each table in this Section that can be reached thanks to collaboration between industry and HEP.  
...
%\toprule
\hline
\textbf{Research Objective:} & \textbf{Outcomes (corresponding to groups of deliverables):} \\
\hline
