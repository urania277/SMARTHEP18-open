...
\fbox{\begin{minipage}{0.985\textwidth}
\textbf{The cross-pollination on RTA between academia and industry in \acronym will lead to concrete deliverables that contribute to improving European transport as per the \href{https://ec.europa.eu/programmes/horizon2020/en/h2020-section/smart-green-and-integrated-transport}{H2020 Societal Challenge for Smart, green and integrated transport}, to enhancing the capabilities and reproducibility of decision-making in finance and to improving industrial processes.}
\end{minipage}}
