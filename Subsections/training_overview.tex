...
\begin{tabular}{|p{7mm}|p{15mm}|p{18mm}|p{10mm}|p{10mm}|p{35mm}|p{50mm}|}%{@{}lp{0.05\textwidth}p{0.05\textwidth}p{0.1\textwidth}p{0.15\textwidth}p{0.2\textwidth}@{}}
\hline
\pbox{8cm}{\textbf{ESR}} & 
...
\ESRe & \dortmundentity  & \dortmundentity & 8 & 36 & Albrecht [8/18] &  Raven [N], \textit{Dungs}  \tabularnewline \hline
\ESRf & \cnrsentity  & \sorbonneentity & 8 & 36 & Crescioli [4], Malaescu [4] & Roda [14], \textit{Sambo}  \tabularnewline \hline
\ESRg & \sorbonneentity  & \sorbonneentity & 8 & 36 & Lacassagne [15/21] & Petersen [2/11], Couturier [4/2], \textit{Catastini}  \tabularnewline \hline
...
\ESRl & \heidelbergentity & \heidelbergentity & 8 & 36 & Starovoitov [7], Dunford [8] & Strom [N], Annovi [N] \textit{Sopasakis} [20] \tabularnewline \hline
\ESRn & \heidelbergentity & \heidelbergentity & 8 & 36 & Hausmann-Menzemer [N] & Albrecht [13], Martinez-Santos [6/3], \textit{Dungs}  \tabularnewline \hline %Borsato [8], 
...
\footnotesize 
\vskip2pt
Table 1.2: Recruitment deliverables per beneficiary, and supervisors/tutors with number of supervised PhD/Master's students in brackets. 
...
Table 1.2 presents the recruitment deliverables per participant. 
