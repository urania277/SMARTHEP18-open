...
\pbox{8cm}{\Tstrut 11. \ibmlong \Bstrut} &%
...
Paris, FRA & 
%\pbox{8cm}{Type of R\&D\\activities} & 
\pbox{8cm}{\Tstrut algorithm development\\consulting} & 
%\pbox{8cm}{Full-time\\employees} &  
5 & 
%\pbox{8cm}{Employees\\in R\&D} & 
4&
%\pbox{8cm}{Website} &  
\url{www.dreamquark.com}  & 
%\pbox{8cm}{Annual\\turnover} & 
250\,k\euro & 
%\pbox{8cm}{Enterprise\\status} &
YES & 
...
%
%\pbox{8cm}{\Tstrut \technopolislongbroken \Bstrut} & \technopolis &  &\checkmark & & AT & & \pbox{8cm}{\Tstrut Dr. Fritz Ohler} & specialised training \tabularnewline  \hline
%
