...
IT & \pbox{8cm}{--} & \pbox{8cm}{Francesco Sambo}  
\tabularnewline\hline
...
\begin{center}\small
\resizebox {\textwidth}{!}{%
\begin{tabular}{|p{19mm}|p{24mm}|p{43mm}|p{15mm}|p{15mm}|p{33mm}|p{12mm}|p{20mm}|p{9mm}|}
...
%Name & 
\fleetmaticsentity (subsidiary of Verizon)& 
%\pbox{8cm}{\Tstrut Location\\ premises\Bstrut} &
Firenze, IT & 
%\pbox{8cm}{Type of R\&D\\activities} & 
...
%\pbox{8cm}{Annual\\turnover} & 
109\,B\euro (consolidated with Verizon)& 
%\pbox{8cm}{Enterprise\\status} &
YES & 
%\pbox{8cm}{SME\\status} \tabularnewline \hline
